...
@Mod(modid = MusicMagic.MODID, version = MusicMagic.VERSION)
public class MusicMagic {
    ...
    public static final String MODID = "musicmagic";
    public static final String VERSION = "1.0";

    // The instance of your mod that Forge uses.  Optional.
    @Mod.Instance(MusicMagic.MODID)
    public static MusicMagic instance;

    // Says where the client and server 'proxy' code is loaded.
    @SidedProxy(clientSide="andrewmogo.ClientOnlyProxy", serverSide="andrewmogo.DedicatedServerProxy")
